...
def main(args):
    ...
    # TODO. check the path of weights
    mobilesamv2, ObjAwareModel, predictor = torch.hub.load("/home/shu/3DGS/GraspSplats/weights", args.mobilesamv2_encoder_name, source="local")
